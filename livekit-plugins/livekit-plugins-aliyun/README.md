...
Realtime speech-to-text support for LiveKit Agents using Aliyun DashScope.

The plugin exposes `livekit.plugins.aliyun.STT` and is intended for streaming
speech recognition in an `AgentSession`.
